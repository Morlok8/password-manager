<script setup lang="ts">
    ...
    import ButtonTable from '../ui/ButtonTable.vue';
...
<template>
    ...
    <td v-else v-bind:class = tdClass>
        ...
        <ButtonTable icon="mdi:account-edit-outline" class='bg-blue-500 text-white rounded-sm p-1' v-bind:onClick="()=>editHandler()"/>
        <ButtonTable icon="mdi:trash-can" class='bg-red-500 text-white rounded-sm p-1 ml-3' v-bind:onClick="()=>deleteHandler()"/>
    </td>
</template>